<template>
    <ContentField style="width: 60vw;">
        <div>
            ...
            <span style="font-size: 30px; font-weight: 600;">论坛</span>
            ...
            <div class="row" style="padding: 25px;">
                ...
                <div class="col-6">
                    ...
                    <div style="color: darkgrey;">
                        ...
                        {{ post.post.readCount }} 阅读
                    </div>
                </div>
                <div class="col-5">
                    <button type="button" class="btn btn-danger" style="width: 12vh; margin-left: 12vh;">
                ...
                <div style="margin-top: 1vh;">
                    ...
                    <div>
                        <span class="hover" @click="like_post(post.post.id.toString())">
                            ...
                            <svg v-if="post.isLove === true" style="color: hotpink;" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
                        ...
                        <span style="margin-left: 3vh;" class="hover" @click="star_post(post.post.id.toString())">
                            ...
                            <svg v-if="post.isStar === true" style="color: gold;" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
...
export default {
    ...
    setup() {
        ...
        const like_post = (post_id) => {
            $.ajax({
                url: "http://127.0.0.1:3000/post/likepost/",
                type: "post",
                data: {
                    user_id: store.state.user.id,
                    post_id: post_id
        ...
        const star_post = (post_id) => {
            $.ajax({
                url: "http://127.0.0.1:3000/post/starpost/",
                type: "post",
                data: {
                    user_id: store.state.user.id,
                    post_id: post_id
